...
- Talisman
- PolkadotJS
- Ledger (Still under review by the ledger team - No recommend at this moment)
...
Selecting your connect method (PolkadotJS in this example) you will see a success message
