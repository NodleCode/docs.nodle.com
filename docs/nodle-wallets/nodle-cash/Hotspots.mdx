...
:::tip Only operate one app per device. If you operate the Hotspot app and the Nodle app at once, there will be conflicts which lead to missing out on rewards. :::
...
No, the Hotspot app is meant to be used on old or secondary smartphones that you no longer use and that can be
...
Nodle development team will support any device manufacturers who wants to develop dedicated hardware.  
