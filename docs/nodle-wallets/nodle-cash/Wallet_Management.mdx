...
Consider your public key as your "postal address" in the world of Nodle Cash, similar to how your email address serves to receive emails. Feel free to share your public key with others. They'll use it to send you Nodle Cash, just as they would use your email address to send you an email. 

Curious where you can find your public key? It's simple! Open your Nodle Cash app, from the map view tap the menu icon at the top left of the screen, then select "Wallet." From here, tap the "Receive" button found under your account balance.
