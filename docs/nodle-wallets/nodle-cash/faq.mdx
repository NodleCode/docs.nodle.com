...
We only support the [Talisman](./nodle-wallets/talisman/introduction) wallet now.
You can also [re-import you Nodle wallet from the app to the web](./reimport-your-account).

Other wallets are not supported now.
