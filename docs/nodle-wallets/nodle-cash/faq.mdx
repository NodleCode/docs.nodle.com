...
We recommend you use [Talisman](./nodle-wallets/talisman/introduction) for managing your wallet on desktop. However, third parties such as Polkadot JS, SubWallet, or Nova should be compatible as well if you use a non-legacy Nodle wallet.
...
4. Create a new wallet as you did it before
5. Backup the new wallet
6. Check your new wallet public key by clicking the "Receive" button and save it
7. Switch to your current wallet by disconnecting the new one and importing the current using a 12-word recovery phrase
8. Transfer your balance to the new wallet using your new public key by clicking the "Send" button
9. Switch back to your new wallet again
10. You are done! Continue enjoying the Nodle Cash app!

### What if I received a transfer to a legacy wallet after being upgraded?

No worries, your tokens are not lost! You can [re-import your legacy wallet to a web wallet](./reimport-your-account) and 
